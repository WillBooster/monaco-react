...
`react` and `react-dom` are peer dependencies. This package owns its `monaco-editor` dependency for Monaco type resolution. It supports React 19.x, Node.js 24 or newer, and is tested with Next.js 16.
